...
import { type HabitWithStreak, type useHabits } from '@/hooks/use-habits';
...
type HabitsState = ReturnType<typeof useHabits>;
      ...
      <View style={styles.weekRow}>
        {DAYS.map((day, i) => (
          <View key={`${day}-${i}`} style={[styles.dayCircle, i === todayIndex && styles.dayCircleActive]}>
            <AppText variant="label" color={i === todayIndex ? palette.success : palette.textSecondary}>
              {day}
            </AppText>
          </View>
        ))}
